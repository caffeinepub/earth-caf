...
export class Backend implements backendInterface {
    ...
    async addGalleryImage(arg0: string, arg1: string, arg2: string): Promise<GalleryImage> {
        if (this.processError) {
            try {
    ...
    async addMenuItem(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: boolean): Promise<MenuItem> {
        if (this.processError) {
            try {
    ...
    async createBooking(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string): Promise<Booking> {
        if (this.processError) {
            try {
    ...
    async updateBookingStatus(arg0: string, arg1: string): Promise<Booking> {
        if (this.processError) {
            try {
    ...
    async updateGalleryImage(arg0: string, arg1: string, arg2: string, arg3: string): Promise<GalleryImage> {
        if (this.processError) {
            try {
    ...
    async updateMenuItem(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: boolean): Promise<MenuItem> {
        if (this.processError) {
            try {
